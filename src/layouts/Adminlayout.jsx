            ...
            <div className="flex items-center">
              {!sidebarCollapsed && (
                <>
                  ...
                  />
                  <div>
                    <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100">Electra</h1>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Admin Panel</p>
                  </div>
                </>
              )}
              {sidebarCollapsed && (
                <div className="w-8 h-8 bg-red-600 rounded-lg flex items-center justify-center ring-0 dark:bg-white dark:shadow-lg dark:ring-1 dark:ring-white/20">
                  <img 
                    src="/src/assets/images/logo.png" 
                    alt="Electra Logo" 
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="relative" ref={dropdownRef}>
              <button
                ...
                className="flex items-center space-x-3 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors active:scale-[0.98]"
              >
                <div className="h-8 w-8 bg-gradient-to-r from-red-600 to-red-700 rounded-full flex items-center justify-center shadow-md">
                 ...
                 <div className="text-left hidden sm:block">
                   <p className="text-sm font-medium text-gray-900 dark:text-gray-100">Nguyễn Minh Quân</p>
                   <p className="text-xs text-gray-500 dark:text-gray-400">Quản trị viên hệ thống</p>
                 </div>
                <svg 
              ...
              {isDropdownOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-white dark:bg-gray-800 rounded-md shadow-lg ring-1 ring-black ring-opacity-5 dark:ring-gray-600 focus:outline-none z-50 origin-top-right animate-in fade-in zoom-in-95">
                  <div className="py-1">
                    <div className="px-4 py-3 border-b border-gray-100 dark:border-gray-700">
                      <p className="text-sm font-medium text-gray-900 dark:text-gray-100">Nguyễn Minh Quân</p>
                      <p className="text-sm text-gray-500 dark:text-gray-400">admin.quan@electra.vn</p>
                      <p className="text-xs text-gray-400 dark:text-gray-500">Quản trị viên hệ thống</p>
                    </div>
                    <button
