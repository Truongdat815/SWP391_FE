  ...
  return (
    <div className="min-h-screen bg-gray-50 p-2 sm:p-3 md:p-4">
      <div className="w-full max-w-7xl mx-auto">
        {/* Header */}
        <div className="bg-gradient-to-r from-blue-50 to-white border border-blue-100 rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5 mb-3 sm:mb-4 shadow-sm">
        ...
        <div className="grid grid-cols-12 gap-3 sm:gap-4">
          ...
          <div className="col-span-12 lg:col-span-3">
            <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-3 sm:p-4 sticky top-4">
