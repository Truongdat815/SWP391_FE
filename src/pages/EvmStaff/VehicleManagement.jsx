          ...
          <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-xl border border-white/20 p-4">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              ...
              <button
                ...
                className="group px-4 py-2 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg hover:from-green-700 hover:to-green-800 transition-all duration-300 shadow-md hover:shadow-xl flex items-center gap-2"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-end">
            ...
            <div className="lg:col-span-4">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-gray-50/50"
                />
              </div>
            </div>
            ...
            <div className="lg:col-span-2">
              ...
              <select
                ...
                className="block w-full px-3 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-gray-50/50"
              >
        ...
        {status === 'loading' && models.length === 0 ? (
          ...
          <div className="bg-white/80 backdrop-blur-lg rounded-2xl shadow-md border border-white/20 p-12">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">Thử điều chỉnh bộ lọc hoặc thêm xe mới</p>
              <button
                onClick={handleOpenCreate}
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                      ...
                      <div className="lg:col-span-2">
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white/80 backdrop-blur-sm transition-all duration-200 placeholder-gray-400"
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white/80 backdrop-blur-sm transition-all duration-200"
                          required
                          min={2020}
                          max={2030}
                        />
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            onWheel={handleWheelOnNumberInput}
                            className="w-full px-4 py-3 pr-12 border border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white/80 backdrop-blur-sm transition-all duration-200"
                            required
                            min={0.1}
                            placeholder="85.0"
                          />
                      ...
                      <div>
                        ...
                        <div className="relative">
                          <input
                            ...
                            onWheel={handleWheelOnNumberInput}
                            className="w-full px-4 py-3 pr-16 border border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white/80 backdrop-blur-sm transition-all duration-200"
                            required
                            min={2}
                            max={9}
                            placeholder="5"
                    ...
                    <div>
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 bg-white/80 backdrop-blur-sm resize-none transition-all duration-200 placeholder-gray-400"
                          rows={4}
                ...
                <div className="sticky bottom-0 bg-gradient-to-r from-gray-50/90 to-white/90 backdrop-blur-xl border-t border-white/20 p-4 mt-8 -mx-8 -mb-8">
                  <div className="flex gap-4">
                    ...
                    <button
                      ...
                      className="flex-1 bg-gradient-to-r from-green-600 to-green-700 text-white px-4 py-2 rounded-lg font-medium hover:from-green-700 hover:to-green-800 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 shadow-md hover:shadow-xl flex items-center justify-center gap-2"
                    >
                      {status === 'loading' ? (
                        <>
