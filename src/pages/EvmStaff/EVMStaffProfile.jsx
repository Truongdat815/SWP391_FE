...
const EVMStaffProfile = ({ onBack }) => {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-2 sm:px-3 md:px-4 lg:px-6 py-3 sm:py-4 md:py-5">
      ...
      <div className="bg-gradient-to-r from-emerald-50 to-white border border-emerald-100 rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5 shadow-sm mb-3 sm:mb-4">
        <div className="flex items-center gap-2 sm:gap-3 md:gap-4">
          <div className="h-12 w-12 sm:h-14 sm:w-14 md:h-16 md:w-16 rounded-full bg-emerald-100 flex items-center justify-center ring-4 sm:ring-6 md:ring-8 ring-white shadow flex-shrink-0">
            <span className="text-emerald-600 font-bold text-base sm:text-lg md:text-xl">ES</span>
          </div>
          <div className="min-w-0 flex-1">
            <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Thông tin cá nhân</h1>
            <p className="text-xs sm:text-sm md:text-base text-gray-600 mt-0.5 sm:mt-1">Quản lý hồ sơ nhân viên EVM</p>
          </div>
        </div>
      </div>
