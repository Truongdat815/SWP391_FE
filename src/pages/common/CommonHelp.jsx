        ...
        <div className="lg:col-span-2 space-y-4 sm:space-y-5 md:space-y-6">
          ...
          <section className="bg-white rounded-xl sm:rounded-2xl shadow-sm border border-gray-200 p-4 sm:p-5 md:p-6 hover:shadow-md transition-all duration-200">
            ...
            <div className="space-y-2 sm:space-y-3">
              <a className="block p-3 sm:p-4 rounded-lg sm:rounded-xl border bg-gray-50 hover:bg-gray-100 transition-all duration-200 text-xs sm:text-sm md:text-base" href="#">
