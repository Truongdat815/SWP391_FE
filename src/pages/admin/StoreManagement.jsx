              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center space-x-2">
                    <Tooltip content="Chỉnh sửa thông tin cửa hàng" placement="top">
                      <button 
                    ...
                    <Tooltip content="Xóa cửa hàng khỏi hệ thống" placement="top">
                      <button 
                    ...
                    <Tooltip content="Xem chi tiết thông tin cửa hàng" placement="top">
                      <button className="p-2 rounded-lg bg-green-50 text-green-600 hover:bg-green-100 hover:shadow-md transition-all duration-200 transform hover:scale-105">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <div className="px-6 space-y-6">
      ...
      <div className="flex justify-end space-x-3">
        <Tooltip content="Thêm cửa hàng mới vào hệ thống" placement="bottom">
          <button
            onClick={() => setShowAddModal(true)}
        ...
        <Tooltip content="Xuất báo cáo danh sách cửa hàng ra file Excel" placement="bottom">
