        ...
        <SwiperSlide>
          <div className="relative h-[500px]">
            ...
            <div className="absolute left-6 md:left-12 bottom-8 md:bottom-12 text-white max-w-xl">
              ...
              <button className="mt-4 inline-flex items-center px-5 py-2.5 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-semibold">Tìm hiểu thêm</button>
            </div>
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide>
          <div className="relative h-[500px]">
            ...
            <div className="absolute left-6 md:left-12 bottom-8 md:bottom-12 text-white max-w-xl">
              ...
              <button className="mt-4 inline-flex items-center px-5 py-2.5 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-semibold">Đặt lịch lái thử</button>
            </div>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="relative h-[500px]">
            ...
            <div className="absolute left-6 md:left-12 bottom-8 md:bottom-12 text-white max-w-xl">
              ...
              <button className="mt-4 inline-flex items-center px-5 py-2.5 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-semibold">Khám phá ngay</button>
            </div>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="relative h-[500px]">
            ...
            <div className="absolute left-6 md:left-12 bottom-8 md:bottom-12 text-white max-w-xl">
              ...
              <button className="mt-4 inline-flex items-center px-5 py-2.5 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-semibold">Xem chi tiết</button>
            </div>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="relative h-[500px]">
            ...
            <div className="absolute left-6 md:left-12 bottom-8 md:bottom-12 text-white max-w-xl">
              ...
              <button className="mt-4 inline-flex items-center px-5 py-2.5 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-semibold">Nhận ưu đãi</button>
            </div>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="relative h-[500px]">
            ...
            <div className="absolute left-6 md:left-12 bottom-8 md:bottom-12 text-white max-w-xl">
              ...
              <button className="mt-4 inline-flex items-center px-5 py-2.5 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-semibold">Đặt cọc ngay</button>
            </div>
          </div>
        </SwiperSlide>
      </Swiper>
