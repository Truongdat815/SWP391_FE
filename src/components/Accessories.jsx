...
const Accessories = () => {
  console.log('Accessories component is rendering');
  const accessories = [
    {
      id: 1,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {accessories.map((accessory) => (
            <div key={accessory.id} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
              <div className="aspect-w-16 aspect-h-9 bg-gray-200">
                <img 
                  ...
                  onError={(e) => {
                    e.target.src = "https://via.placeholder.com/400x200/e5e7eb/9ca3af?text=Phu+kien+xe";
                  }}
                />
              </div>
              <div className="p-6">
