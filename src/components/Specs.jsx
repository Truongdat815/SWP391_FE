...
const Specs = () => {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-slate-900 via-slate-800 to-emerald-950 relative overflow-hidden">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          {specifications.map((spec, _index) => (
            <button
              ...
              type="button"
              onClick={() => {
                console.log('Clicking spec:', spec.id, 'Current activeSpec:', activeSpec);
                setActiveSpec(spec.id);
              }}
              className={`flex items-center space-x-3 px-6 py-4 rounded-xl font-semibold transition-all duration-300 cursor-pointer select-none ${
                activeSpec === spec.id
          ...
          <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-white/20">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="text-3xl font-bold bg-gradient-to-r from-emerald-400 to-emerald-300 bg-clip-text text-transparent mb-2">80%</div>
                <div className="text-slate-300">Tiết kiệm chi phí nhiên liệu</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold bg-gradient-to-r from-sky-400 to-sky-300 bg-clip-text text-transparent mb-2">0</div>
                <div className="text-slate-300">Khí thải CO2</div>
              </div>
              <div className="text-center">
                <div className="text-3xl font-bold bg-gradient-to-r from-amber-400 to-amber-300 bg-clip-text text-transparent mb-2">95%</div>
                <div className="text-slate-300">Hiệu suất năng lượng</div>
              </div>
            </div>
          </div>
        </motion.div>
