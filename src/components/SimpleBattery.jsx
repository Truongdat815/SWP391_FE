...
import limousineImage from '../assets/images/limo.webp'
import minioImage from '../assets/images/minio.webp'
            ...
            {batteryFeatures.map((feature) => (
              <div key={feature.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                <div className="h-48 overflow-hidden relative">
                  ...
                  />
                  <div className="absolute top-4 left-4 bg-white bg-opacity-90 rounded-full w-16 h-16 flex items-center justify-center text-2xl">
                    {feature.icon}
                  </div>
                </div>
                <div className="p-6">
